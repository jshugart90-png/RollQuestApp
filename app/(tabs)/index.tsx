...
export default function HomeScreen() {
  ...
  return (
    ...
    <ScrollView style={{ flex: 1 }} contentContainerStyle={{ padding: 18, gap: 14 }}>
      <Text style={{ color: "#FFFFFF", fontSize: 32, fontWeight: "900" }}>{gymName}</Text>
          ...
          {BELTS.map((belt) => (
            <Pressable
              ...
              style={{
                ...
                borderRadius: 999,
                borderWidth: 1,
                borderColor: progress.currentBelt === belt ? accentColor : "#2A2A2A",
                backgroundColor: progress.currentBelt === belt ? withAlpha(accentColor, 0.18) : "#0F0F0F",
              }}
            >
